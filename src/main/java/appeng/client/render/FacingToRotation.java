...
public enum FacingToRotation implements StringRepresentable {
    ...
    // DUNSWE
    // @formatter:off
    DOWN_DOWN(new Vector3f(0, 0, 0)), // Invalid, NOOP
    DOWN_UP(new Vector3f(0, 0, 0)), // Invalid, NOOP
    ...
    UP_DOWN(new Vector3f(0, 0, 0)), // Invalid, NOOP
    UP_UP(new Vector3f(0, 0, 0)), // Invalid, NOOP
    ...
    NORTH_UP(new Vector3f(0, 0, 0)), // Default
    NORTH_NORTH(new Vector3f(0, 0, 0)), // Invalid, NOOP
    NORTH_SOUTH(new Vector3f(0, 0, 0)), // Invalid, NOOP
    ...
    SOUTH_NORTH(new Vector3f(0, 0, 0)), // Invalid, NOOP
    SOUTH_SOUTH(new Vector3f(0, 0, 0)), // Invalid, NOOP
    ...
    WEST_WEST(new Vector3f(0, 0, 0)), // Invalid, NOOP
    WEST_EAST(new Vector3f(0, 0, 0)), // Invalid, NOOP
    EAST_DOWN(new Vector3f(0, -90, 180)),
    EAST_UP(new Vector3f(0, -90, 0)),
    EAST_NORTH(new Vector3f(0, -90, 90)),
    EAST_SOUTH(new Vector3f(0, -90, -90)),
    EAST_WEST(new Vector3f(0, 0, 0)), // Invalid, NOOP
    EAST_EAST(new Vector3f(0, 0, 0)); // Invalid, NOOP
    // @formatter:on
